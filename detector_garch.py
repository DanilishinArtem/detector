...
class Detector:
    ...
    def detect_garch(self, t, metric):
        returns = np.array(self.metric_history[0:-1])
        ...
        self.metric_head[t-1] = garch_forecast.mean.values[0][0]
        self.metric_sd[t-1] = 
    ...
    def detect_statistic(self, t, metric):
            t = t + 1
