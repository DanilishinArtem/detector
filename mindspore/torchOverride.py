...
def override_GRAPH_MODE(self, network, loss_fn=None, optimizer=None, metrics=None, eval_network=None, eval_indexes=None,
    ...
    global model
    model = backup_GRAPH_MODE(self, network, loss_fn, optimizer, metrics, eval_network, eval_indexes, amp_level, boost_level, **kwargs)
    
    # temp_node = self.train_network.network._backbone.fc1.matmul
    # def new_construct(x1, x2):
    #     print('hello from matmul')
    #     return temp_node(x1, x2)
    # self.train_network.network._backbone.fc1.matmul = new_construct
...
#     logging.warning('_build_boost_network: ' + str(_build_boost_network))
